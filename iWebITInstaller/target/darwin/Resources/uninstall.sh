...
find "/usr/local/bin/" -name "iWebITAgent-2.4.7.0" | xargs rm
if [ $? -eq 0 ]
then
...
[ -e "/Library/Application Support/iWebITAgent" ] && rm -rf "/Library/Application Support/iWebITAgent"
if [ $? -eq 0 ]
then
